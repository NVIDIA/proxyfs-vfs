...
/* #undef HAVE_CONFIG_H */
#define BUILD_SYSTEM "Linux localhost.localdomain 3.10.0-693.11.1.el7.x86_64 #1 SMP Mon Dec 4 23:52:40 UTC 2017 x86_64 x86_64 x86_64 GNU/Linux"
#define HAVE_SYS_UTSNAME_H 1
#define SYSTEM_UNAME_SYSNAME "Linux"
#define SYSTEM_UNAME_MACHINE "x86_64"
#define SYSTEM_UNAME_RELEASE "3.10.0-693.11.1.el7.x86_64"
#define SYSTEM_UNAME_VERSION "#1 SMP Mon Dec 4 23:52:40 UTC 2017"
...
#define STRING_STATIC_MODULES "vfs_default vfs_posixacl auth_domain auth_builtin auth_sam auth_winbind pdb_smbpasswd pdb_tdbsam pdb_wbc_sam auth_unix auth_wbc nss_info_template idmap_tdb idmap_passdb idmap_nss pdb_samba_dsdb auth_samba4 vfs_dfs_samba4 pdb_ldapsam idmap_ldap"
...
#define static_decl_auth extern NTSTATUS auth_domain_init(void); extern NTSTATUS auth_builtin_init(void); extern NTSTATUS auth_sam_init(void); extern NTSTATUS auth_winbind_init(void); extern NTSTATUS auth_unix_init(void); extern NTSTATUS auth_wbc_init(void); extern NTSTATUS auth_samba4_init(void);
#define static_init_auth { auth_domain_init();  auth_builtin_init();  auth_sam_init();  auth_winbind_init();  auth_unix_init();  auth_wbc_init();  auth_samba4_init(); }
